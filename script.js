...
const sr = ScrollReveal ({
  ...
  sr.reveal('.menu-visit',{ delay:350, origin:'top' })
  sr.reveal('.menu-visit-text',{ delay:350, origin:'bottom' })
  sr.reveal('.tour-main-content',{ delay:350, origin:'bottom' })
  sr.reveal('.before',{ delay:550, origin:'top' })
  sr.reveal('.before h1',{ delay:550, origin:'top' })
